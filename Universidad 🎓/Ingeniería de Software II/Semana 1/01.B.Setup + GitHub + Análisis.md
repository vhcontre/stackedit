...
Este proyecto es una práctica de curso para aprender desarrollo web con backend en Python (FastAPI) y frontend en Angular, aplicando principios de ingeniería de software, control de versiones y despliegue.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MTEzMTE3NjNdfQ==
-->