...
| **Unidad 3: Arquitectura**  | Uso de patrones (MVC, Strategy), diseño modular, separación de capas, UI con Angular                     | 2–3, 5–9      |
...
* Instalación de VS Code, entorno Python, Angular CLI.
...
* Inicio del frontend Angular: layout base, routing, módulos.
* Listado y formulario simple para productos y depósitos.

#### Semana 8

* Registro de movimientos desde frontend.
