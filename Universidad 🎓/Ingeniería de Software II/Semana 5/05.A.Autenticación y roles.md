...
## 🧪 Paso 1: Crear motor de pruebas en `conftest.py`
...
### 1. `setup_test_db()` se ejecuta automáticamente
...
Esto **limpia todas las tablas** después de cada test individual para que **el estado no se contamine entre tests**.
...
* Siempre verificar que los usuarios/roles requeridos se creen antes del test.
* Recordar que `get_db` debe ser la función, no un fixture.
* Usar `yield` dentro de fixtures asegura que se limpie correctamente el estado.

---

¿Querés que te agregue ejemplos de creación de usuario `admin` dentro de un fixture o helper para usar en los tests también?


<!--stackedit_data:
eyJoaXN0b3J5IjpbMjE0MDc5MzE1NSwtMTUzMjM3MjUyNywtMT
EwNDg1OTQ5MiwtNTYyODk4ODU5LC0xNDU4MTg0NDA3LC0yMTU4
ODg3MzgsMTUzODY1MjU5OCwtNTE2MDcyMTU4LC0xNzc1NTc1Mz
MyLDQ3Nzk3MDAzMiwtMjAxMjA4NjAyNiwtMjAyODUzMDYxNCw1
MzIxNjE0MDEsLTM2Mjc5MzAzNiwtMTgwMjAwNDYxMiw5NDYwND
Y1NjBdfQ==
-->