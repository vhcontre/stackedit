...
¿Querés que lo preparemos también para que se use `sqlite:///./inventario.db` sin errores en GitHub Actions, o preferís correrlo todo en memoria (`sqlite:///:memory:`) para testing rápido?
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTkwMTI1NDkyMCwxNjI4OTIwMDgzLC0xNz
Y1MjMxNjU0LDMyNjkxNDY4NywxNjM2NjUzNjk2LC04ODQ0MjUz
MTldfQ==
-->